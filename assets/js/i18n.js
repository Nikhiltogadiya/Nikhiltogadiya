...
const translations = {
  en: {
    ...
    'hero.description':  'I build multi-agent AI systems, fine-tune LLMs with grammar constraints, and ship ML pipelines — my focus is getting research ideas running in real-world robotics.',
    ...
    'exp1.p2': 'Hit 90%+ answer coverage and sub-1s response times using confidence-gated prompting for multilingual visitors.',
    ...
    'exp2.p5': 'Ran BLEU, SacreBLEU, and ROUGE-L evaluations against human-written reference tests.',
    ...
    'exp3.p2': 'Picked the best architecture based on MAE and RMSE.',
    'exp3.p3': 'Built the full pipeline: data preprocessing, feature engineering, sequence modeling, and validation.',
    'exp3.p4': 'Set up a FastAPI endpoint serving real-time energy predictions.',
    'exp3.p5': 'Wrapped it all in Docker and plugged the forecasts into management dashboards.',
    ...
    'proj2.p1': 'Built an ML pipeline that predicts game-day attendance and revenue for a pro ice hockey team.',
    'proj2.p2': 'Trained on 3 seasons of real sales data, achieving R² = 0.76 with ~90% accuracy.',
    'proj2.p3': 'Put together 19 features (weather, holidays, opponent strength, team form) from different data sources.',
    ...
    'proj3.p5': 'Ran BLEU, SacreBLEU, and ROUGE-L evaluations against human-written reference tests.',
    ...
    'proj4.p2': 'Picked the best architecture based on MAE and RMSE.',
    'proj4.p3': 'Built the full pipeline: data preprocessing, feature engineering, sequence modeling, and validation.',
    'proj4.p4': 'Set up a FastAPI endpoint serving real-time energy predictions.',
    'proj4.p5': 'Wrapped it all in Docker and plugged forecasts into management dashboards.',
    ...
    'proj5.p2': 'Fuses sensor data to control velocity in real time.',
    'proj5.p3': 'Uses computer vision for lane detection so the robot stays centered.',
    'proj5.p4': 'Added autonomous grid navigation using BFS pathfinding.',
    'proj5.p5': 'Wrote an A*-based Sokoban puzzle solver that handles obstacles on its own.',
    'proj5.p6': 'Ties together odometry, camera feeds, and velocity commands in a modular ROS 2 setup.',
    ...
    'proj6.p2': 'It dodges collisions, stays in lane, and hits target speed using actor-critic networks.',
    ...
    'proj6.p4': 'Deals with noisy sensor data gracefully in ROS 2 / Webots.',
    ...
    'proj6.p6': 'Keeps safe following distance and adjusts speed on its own.',
  ...
  de: {
    ...
    'exp1.p2': 'Über 90 % Antwortabdeckung und unter 1 Sekunde Antwortzeit dank Confidence-Gated Prompting für mehrsprachige Besucher.',
    ...
    'exp2.p5': 'BLEU, SacreBLEU und ROUGE-L gegen menschlich geschriebene Referenztests ausgewertet.',
    ...
    'exp3.p2': 'Beste Architektur anhand von MAE und RMSE ausgewählt.',
    'exp3.p3': 'Komplette Pipeline gebaut: Datenvorverarbeitung, Feature Engineering, Sequenzmodellierung und Validierung.',
    'exp3.p4': 'FastAPI-Endpoint aufgesetzt, der Energieprognosen in Echtzeit liefert.',
    'exp3.p5': 'Das Ganze in Docker gepackt und die Prognosen an Management-Dashboards angebunden.',
    ...
    'proj2.p3': '19 Features (Wetter, Feiertage, Gegnerstärke, Teamform) aus verschiedenen Datenquellen zusammengestellt.',
    ...
    'proj3.p5': 'BLEU, SacreBLEU und ROUGE-L gegen menschlich geschriebene Referenztests ausgewertet.',
    ...
    'proj4.p2': 'Beste Architektur anhand von MAE und RMSE ausgewählt.',
    'proj4.p3': 'Komplette Pipeline gebaut: Datenvorverarbeitung, Feature Engineering, Sequenzmodellierung und Validierung.',
    'proj4.p4': 'FastAPI-Endpoint aufgesetzt, der Energieprognosen in Echtzeit liefert.',
    'proj4.p5': 'Das Ganze in Docker gepackt und die Prognosen an Management-Dashboards angebunden.',
    ...
    'proj5.p2': 'Fusioniert Sensordaten für die Geschwindigkeitssteuerung in Echtzeit.',
    'proj5.p3': 'Nutzt Computer Vision zur Spurerkennung, damit der Roboter mittig bleibt.',
    'proj5.p4': 'Autonome Grid-Navigation mit BFS-Pfadplanung ergänzt.',
    'proj5.p5': 'A*-basierter Sokoban-Löser, der Hindernisse selbstständig umgeht.',
    'proj5.p6': 'Verbindet Odometrie, Kamera-Feeds und Geschwindigkeitsbefehle in einem modularen ROS 2-Aufbau.',
    ...
    'proj6.p2': 'Er weicht Kollisionen aus, hält die Spur und trifft die Zielgeschwindigkeit — alles über Actor-Critic-Netzwerke gelernt.',
    ...
    'proj6.p4': 'Kommt auch mit verrauschten Sensordaten in ROS 2 / Webots gut klar.',
    'proj6.p5': '<strong>Adaptiver Tempomat (IDM):</strong> Längsregelungs-ACC mit dem Intelligent Driver Model und Radardaten gebaut.',
    'proj6.p6': 'Hält sicheren Abstand und regelt die Geschwindigkeit von selbst.',
